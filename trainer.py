...
class DebuggerBase:
    ...
    def _get_now(self):
        return str(time.strftime('%Y%m%d_%H_%M', time.gmtime()))
...
class LSTMDebugger(DebuggerBase):
    ...
    def _epoch_train(self):
        print("entered epoch_train function:\n")
        tag_loss, stop_loss, word_loss, loss = 0, 0, 0, 0
        self.extractor.train()
        print("Visual Net trained")
        self.mlc.train()
        print("MLC trained")
        self.co_attention.train()
        print("Co-attention trained")
        ...
        for i, (images, _, label, captions, prob) in enumerate(self.train_data_loader):
            ...
            print(tag_loss,stop_loss,word_loss,loss)
...
if __name__ == '__main__':
    ...
    # Path Argument
    parser.add_argument('--vocab_path', type=str, default='./data/agmir_data/vocab.pkl',
                        help='the path for vocabulary object')
    parser.add_argument('--image_dir', type=str, default='./data/images',
                        help='the path for images')
    parser.add_argument('--caption_json', type=str, default='./data/agmir_data/captions.json',
                        help='path for captions')
    parser.add_argument('--train_file_list', type=str, default='./data/agmir_data/train_data.txt',
    ...
    # MLC
    parser.add_argument('--classes', type=int, default=643)
